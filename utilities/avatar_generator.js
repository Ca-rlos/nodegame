    ...
    generateAvatar: function () { 
        ...
        const bodySections = {
            ...
            pants: [{X: '8', Y: '2'}, {X: '8', Y: '3'}, {X: '8', Y: '4'}, 
                    ...
                    {X: '12', Y: '4'}, {X: '12', Y: '5'}], 
            shoes: [{X: '13', Y: '2'}, {X: '13', Y: '3'}, {X: '13', Y: '4'}, 
                    {X: '13', Y: '5'}], 
            hair: [{X: '1', Y: '2'}, {X: '1', Y: '3'}, {X: '1', Y: '4'}, 
        ...
        Object.keys(bodySections).forEach(section => {
            section.forEach(square => {
                ...
                console.log('picked ' + square.color);
            })
        })
    },
};